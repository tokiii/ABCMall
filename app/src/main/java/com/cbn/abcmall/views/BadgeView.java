...
public class BadgeView extends TextView {
    ...
    public static final int POSITION_TOP = 6;
    ...
    private ShapeDrawable getDefaultBackground() {
        ...
        RectF rectF = new RectF(3,3,3,3);

        RoundRectShape rr = new RoundRectShape(outerR, rectF, innerR);
    ...
    private void applyLayoutParams() {
        ...
        switch (badgePosition) {
            ...
            case POSITION_TOP:
                ...
                lp.setMargins(badgeMarginH * 3, 0, 0, badgeMarginV);
            default:
                break;
        }
